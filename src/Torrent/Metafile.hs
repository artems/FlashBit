...
creationDate :: BCode -> Maybe Integer
creationDate = searchInt "creation date"
...
infoHash bc = do
    ...
    return . SHA1.hash . encode $ info

infoFiles :: BCode -> Maybe [([ByteString], Integer)]
